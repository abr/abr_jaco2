...
# ----TEST PARAMETERS-----
s = 13 # have to manually go through runs
name = '2.2'
notes = 'starting from friction_training5, good to record to show learning'
kp = 4.0
kv = 2.0
vmax = 0.5
...
time_limit = 60  # how long the arm is allowed to reach for the target [sec]
