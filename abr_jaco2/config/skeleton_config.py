""" copied from abr_control repo, branch avoid_joint_limits
commit f7eb1c292bf0657d843a9d2f9b63669d619d1ab5"""
import cloudpickle
import hashlib
import importlib
import numpy as np
...
class RobotConfig():
    ...
    def g(self, q):
        """ Calculates the force of gravity in joint space for the arm
    ...
    def M(self, q):
        """ Calculates the joint space inertia matrix for the arm
